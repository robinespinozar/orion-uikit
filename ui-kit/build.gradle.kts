...
publishing {
    publications {
        create<MavenPublication>("release") {
            groupId = "com.github.robinespinozar"
            artifactId = "orion-ui-kit"
...
dependencies {
    ...
    //Jetpack Compose
    implementation(platform(libs.androidx.compose.bom)) // BOM - Maneja las versiones de Compose automáticamente
